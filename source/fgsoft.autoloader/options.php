...
if ($RIGHT >= "R") :
    ...
    $arAllOptions = array(
        'checkConnectJquery' => array("checkConnectJquery", GetMessage("FGSOFT_AUTOLOADER_OPTIONS_CONNECT_JQUERY"), array("checkbox")),
        'checkAutoload' => array("checkAutoload", GetMessage('FGSOFT_AUTOLOADER_OPTIONS_SHOW_AUTOLOAD'), array("checkbox")),
        'checkPreloader' => array("checkPreloader", GetMessage('FGSOFT_AUTOLOADER_OPTIONS_PRELOADER_OWN'), array("checkbox")),
        'ownPreloader' => array("ownPreloader", GetMessage("FGSOFT_AUTOLOADER_OPTIONS_PRELOADER_OWN"), array("text", 255)),
        'checkTemplate' => array("checkTemplate", GetMessage('FGSOFT_AUTOLOADER_OPTIONS_CHECK_TEMPLATE'), array("checkbox")),
        'tplElement1' => array("tplElement1", GetMessage("FGSOFT_AUTOLOADER_OPTIONS_TEMPLATE_1_ELEMENT"), array("text", 255)),
        'tplElement2' => array("tplElement2", GetMessage("FGSOFT_AUTOLOADER_OPTIONS_TEMPLATE_2_ELEMENTS"), array("text", 255)),
        'tplElement5' => array("tplElement5", GetMessage("FGSOFT_AUTOLOADER_OPTIONS_TEMPLATE_5_ELEMENTS"), array("text", 255)),
        'autoloadSize' => array("autoloadSize", GetMessage("FGSOFT_AUTOLOADER_OPTIONS_AUTOLOADSIZE"), array("text", 10)),
        'checkCoordsConsoleLog' => array("checkCoordsConsoleLog", GetMessage('FGSOFT_AUTOLOADER_OPTIONS_CHECK_COORDS_CONSOLE_LOG'), array("checkbox")),
        'checkAjaxMode' => array("checkAjaxMode", GetMessage('FGSOFT_AUTOLOADER_OPTIONS_CHECK_AJAXMODE'), array("checkbox")),
        'checkStandartPagination' => array("checkStandartPagination", GetMessage('FGSOFT_AUTOLOADER_OPTIONS_CHECK_STANDART_PAGINATION'), array("checkbox")),
        'ownButtonName' => array("ownButtonName", GetMessage("FGSOFT_AUTOLOADER_OPTIONS_OWN_BUTTON_NAME"), array("text", 255)),
...
if ($REQUEST_METHOD == 'POST')
{
    ...
    if ($_REQUEST['form1']['checkConnectJquery'] == "Y" AND $_REQUEST['form1']['checkConnectJquery'] != $value['checkConnectJquery']){
        RegisterModuleDependences("main", "OnPageStart", $module_id, "CFgsoftAutoloader", "connectJquery", 1);
    }
    if ($_REQUEST['form1']['checkConnectJquery'] == "N" AND $_REQUEST['form1']['checkConnectJquery'] != $value['checkConnectJquery']){
        UnRegisterModuleDependences("main", "OnPageStart", $module_id, "CFgsoftAutoloader", "connectJquery", 1);
    }
    ...
    if (!$_REQUEST['form1']['ownButtonName']){
        $_REQUEST['form1']['ownButtonName'] = GetMessage("FGSOFT_AUTOLOADER_OPTIONS_SCRIPT_buttonName");
    }
    ...
    autoloadText: '".GetMessage("FGSOFT_AUTOLOADER_OPTIONS_SCRIPT_autoloadText")."',
    showElementsText: '".GetMessage("FGSOFT_AUTOLOADER_OPTIONS_SCRIPT_showElementsText")."',
    showElementsFrom: '".GetMessage("FGSOFT_AUTOLOADER_OPTIONS_SCRIPT_showElementsFrom")."',
    downloadElementsText: '".GetMessage("FGSOFT_AUTOLOADER_OPTIONS_SCRIPT_downloadElementsText")."',
    downloadElementsTo: '".GetMessage("FGSOFT_AUTOLOADER_OPTIONS_SCRIPT_downloadElementsTo")."',
    textElementsFrom: '".GetMessage("FGSOFT_AUTOLOADER_OPTIONS_SCRIPT_textElementsFrom")."',
...
<?
    ...
    $tabControl->BeginNextTab();
        ...
        ?>
        <tr class=heading>
            <td colspan=2><?=GetMessage("FGSOFT_AUTOLOADER_OPTIONS_GENERAL")?></td>
        </tr>
        ...
        <tr>
            <td valign="top" width="100%" colspan="2" align="center">
                <?=BeginNote();?>
                <?=GetMessage("FGSOFT_AUTOLOADER_OPTIONS_SHOW_AUTOLOAD_ABOUT");?>
                <?=EndNote();?>
            </td>
        </tr>
        ...
        <tr class=heading>
            <td colspan=2><?=GetMessage("FGSOFT_AUTOLOADER_OPTIONS_ADDITIONAL")?></td>
        </tr>
        ...
        <tr class=heading>
            <td colspan=2><?=GetMessage("FGSOFT_AUTOLOADER_OPTIONS_PRELOADER")?></td>
        </tr>

        <tr>
            <td width="40%" nowrap>
                <label><?=GetMessage('FGSOFT_AUTOLOADER_OPTIONS_PRELOADER_DEFAULT')?> : </label>
            </td>
            <td width="60%">
        ...
        <tr>
            <td valign="top" width="100%" colspan="2" align="center">
                <?=BeginNote();?>
                <?=GetMessage("FGSOFT_AUTOLOADER_OPTIONS_SHOW_PRELOADER_ABOUT");?>
                <?=EndNote();?>
            </td>
        </tr>

        <tr class=heading>
            <td colspan=2><?=GetMessage("FGSOFT_AUTOLOADER_OPTIONS_BUTTON_TEMPLATE")?></td>
        </tr>
        ...
        <tr>
            <td valign="top" width="100%" colspan="2" align="center">
                <?=BeginNote();?>
                <?=GetMessage("FGSOFT_AUTOLOADER_OPTIONS_TEMPLATE_ABOUT");?>
                <?=EndNote();?>
            </td>
        </tr>          
    ...
    <input class="adm-btn-save" type="submit" name="save" value="<?=GetMessage("FGSOFT_AUTOLOADER_OPTIONS_SAVE");?>" title="<?=GetMessage("FGSOFT_AUTOLOADER_OPTIONS_SAVE");?>" />&nbsp;
    ...
    <?=BeginNote();?>
        <?=GetMessage("FGSOFT_AUTOLOADER_OPTIONS_HOW_TO_LAUNCH");?>
    <?=EndNote();?>
